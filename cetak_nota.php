...
class PDF extends FPDF
{
    ...
    function LoadData()
    {
        ...
        $data = mysqli_query($con, "select sub_transaksi.jumlah_beli,barang.nama_barang,barang.harga_jual,sub_transaksi.total_harga,sub_transaksi.bayar,sub_transaksi.diskon from sub_transaksi inner join barang on barang.id_barang=sub_transaksi.id_barang where sub_transaksi.id_transaksi='$id'");
    ...
    function BasicTable($header, $data)
    {
        ...
        $getsum = mysqli_query($con, "select sum(total_harga) as grand_total,sum(jumlah_beli) as jumlah_beli , (sum(total_harga)*diskon/100) as potongan from sub_transaksi where id_transaksi='$id'");
